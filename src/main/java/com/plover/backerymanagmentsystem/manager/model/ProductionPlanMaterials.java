...
@Entity
@Table(name = "production_plan_materials")
@com.fasterxml.jackson.annotation.JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ProductionPlanMaterials {
    ...
    @Column(name = "total_raw_material_quantity")
    private Double rawMaterialQuantity;

    @Column(name = "raw_material_quantity_for_kitchen")
    private Double rawMaterialQuantityForKitchen;

    @Column(name = "raw_material_quantity_for_bakery")
